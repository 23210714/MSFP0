...
Nombre del alumno: Maria Luisa Michelle Muñoz Meneses
Número de control: 23210713
Correo institucional: l23210714@tectijuana.edu.mx
...
print(f"Capacitancia Cr es de {Cr} Faradios.\n")
print(f"Resistencia Re es de {Re:.3e} Ohms.\n")
print(f"Resistencia Rr es de {Rr:.3e} Ohms.\n")
print(f"Capacitancia Ce es de {Ce:.3e} Faradios.\n")
